...
WebUI.setText(findTestObject('NewCourse/Page_Automation Testing Site Log in to the site/input_Username_username'), 'admin')
...
WebUI.click(findTestObject('NewCourse/Page_SiteTesting Add a new course/input__saveanddisplay'))

WebUI.verifyElementText(findTestObject('NewCourse/Page_SiteTesting Add a new course/div_- Missing full name'), '- Missing full name')
