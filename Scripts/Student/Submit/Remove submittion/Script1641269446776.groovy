...
WebUI.click(findTestObject('Object Repository/Page_CNTN Test/button_Remove submission'))

WebUI.click(findTestObject('Object Repository/Page_CNTN Test/button_Continue'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_CNTN Test/td_-'), '-')
