...
WebUI.click(findTestObject('Object Repository/Page_Course CNTN/button_Mark as done'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Course CNTN/button_Done'), 'Done')
