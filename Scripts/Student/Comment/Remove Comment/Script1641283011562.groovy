...
WebUI.click(findTestObject('Object Repository/Page_CNTN Test/i_Show comments_icon fa fa-caret-right fa-fw'))

WebUI.click(findTestObject('Object Repository/Page_CNTN Test/i_Tue, 4 Jan 2022, 251 PM_icon fa fa-trash fa-fw'))
